...
public class ChatUpdatesBuilderImpl implements ChatUpdatesBuilder {
    ...
    public ChatUpdatesBuilderImpl setDatabaseManager(DatabaseManager databaseManager) {
...
//        messageHandler.setKernelComm(this.kernelComm);
        ...
        final CustomUpdatesHandler updatesHandler =
                constructor.newInstance(kernelComm, differenceParametersService, databaseManager);
