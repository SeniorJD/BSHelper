...
//        }
    ...
    private int createNewTables() throws SQLException {
        ...
        connetion.executeQuery(CreationStrings.createImportantIDsTable);
    ...
    public void setImportantChatID(int id, String name) {
        try {
            final PreparedStatement preparedStatement = connetion.getPreparedStatement("INSERT INTO importantids (id, name) " +
                    "VALUES (?,?)");
